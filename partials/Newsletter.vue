<template>
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <!-- CTA box -->
      <div class="relative bg-purple-700 py-10 px-8 md:py-16 md:px-12" data-aos="fade-up">
        ...
        <div class="relative flex flex-col lg:flex-row justify-between items-center">
          ...
          <div class="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
            ...
            <p class="text-purple-200 text-lg">Join my weekly newsletter to follow me on my journey.</p>
