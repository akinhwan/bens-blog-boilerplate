              ...
              <div class="w-full" v-show="tab === '2'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div class="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                    ...
                    <a class="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" rel="nofollow noreferrer noopener" target="_blank" href="https://pitchgen.co">
                      <span class="text-sm">Visit this site</span>
                      <svg class="w-3 h-3 fill-current text-purple-400 flex-shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 5H0v2h6v4l6-5-6-5z" />
                      </svg>
              ...
              <div class="w-full" v-show="tab === '3'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div class="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                    ...
                    <a class="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="https://www.soheco.org" rel="nofollow noreferrer noopener" target="_blank">
                      <span class="text-sm">Visit this site</span>
                      <svg class="w-3 h-3 fill-current text-purple-400 flex-shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 5H0v2h6v4l6-5-6-5z" />
                      </svg>
