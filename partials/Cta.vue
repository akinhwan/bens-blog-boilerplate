    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
      <div class="pt-12 md:pt-20 border-t border-b border-gray-800">
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-cta>
          ...
          <!-- Section header -->
          <h1 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-cta]">Ready to work together?</h1>
          <p class="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-cta]">I am always open & available to hearing how I can help you solve your problem.</p>

          <!-- CTA button -->
          <div class="flex justify-center mb-8" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-cta]">
            <a class="btn text-white bg-purple-600 hover:bg-purple-700" href="#0">Schedule a time</a>
          </div>
